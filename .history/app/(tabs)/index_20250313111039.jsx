    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <FontAwesome name='camera' size={24} color='black' marginLeft={10} />
        </View>
      ...
      <View style={styles.hashtags}>
        <Text style={styles.hashtagText}>#Food         <Text style={styles.hashtagText}>#Food #Travel #Shopping #Science</Text>
</Text>
      </View>
      {/* Posts Section */}
      <FlatList
